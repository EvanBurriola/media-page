    ...
    <>
      ...
      <div className="flex flex-row h-screen justify-between">
        <div className="flex flex-col h-fit w-2/4 pt-24">
          ...
          <Link href='/media' className="flex justify-center mx-12 mt-12 text-white hover:bg-blue-800 bg-blue-600 transition-colors duration-300 rounded-3xl drop-shadow-[0_8.2px_1.2px_rgba(0,0,0,0.8)] select-none">Media Use Tree</Link>
